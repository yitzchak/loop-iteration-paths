...
(define-test elements/vector-04
  (is equal
      '(b 1 c 2 d 3 e 4)
      (loop for i being the elements
              in #(a b c d e f g) start 1 end 5
                using (index j)
            collect i
            collect j)))
...
(define-test elements/vector-07
  (is equal
      ...
      (loop for i being the elements
              in #(a b c d e f g) start 1 from-end t
                using (index j)
            collect i
            collect j)))
...
(define-test elements/vector-08
  (is equal
      '(e 4 d 3 c 2 b 1)
      (loop for i being the elements
              in #(a b c d e f g) start 1 end 5 from-end t
                using (index j)
            collect i
            collect j)))
...
(define-test elements/vector-09
  (is equal
      '(e 4 d 3 c 2 b 1 a 0)
      (loop for i being the elements
              in #(a b c d e f g) end 5 from-end t
                using (index j)
            collect i
            collect j)))
